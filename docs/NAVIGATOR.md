...
| `seo` | `SEO_AND_ANALYTICS.md`, `SEO_VISIBILITY_AUDIT.md` | живые запросы к `habitoff.ru` |
...
| `knowledge` | `METHODOLOGY.md`, `SOURCE_REGISTER.md`, `ORIGINS_AND_ATTRIBUTION.md` | контент `/knowledge` |
...
- **31.08.2026 · `CURRENT_STATE.md` спорит сам с собой про бэкапы.** Строка 132 описывает
  работающий `habitoff-backup`, строки 556 и 587 говорят «не настроены, восстановление не
  проверялось». Реализация (`infra/backups/`, 14 файлов, коммит `2843802`) живёт на ветке
  `origin/docs/backups`: 2 коммита впереди `main` и 136 позади. Задача —
  `docs/tasks/T-20260831-01-infra-backups-to-main.md`.
