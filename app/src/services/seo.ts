...
const PAGES: Record<string, PageMeta> = {
  ...
  '/knowledge': {
    ...
    description:
      `${CATALOG_COUNTS.facts} проверенных утверждений и ${CATALOG_COUNTS.myths} разобранных убеждений о курении, вейпе и кальяне. У каждого — уровень доказательности, границы применимости и источник. Плюс разборы по темам.`,
  },
  '/links': {
    title: 'Почему тянет курить в одни и те же моменты — карта связок | Habitoff',
    description:
      `${CATALOG_COUNTS.triggers} пусковых моментов — кофе, конец еды, напряжение, дорога, компания — разобранных до потребности, и ответы, которые закрывают её без никотина.`,
  },
  '/meanings': {
