 ...
 *
 * Главное правило раздела — ADR-0019: **статья не пересказывает утверждение каталога, а
 ...
 * где базы нет. Второго механизма для этого не заводится (ADR-0019); расхождение
