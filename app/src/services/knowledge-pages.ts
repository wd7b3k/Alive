 ...
 * как в разделе.
 *
 * Тексты утверждений подставляются из каталога (ADR-0020). Своего текста утверждения у
