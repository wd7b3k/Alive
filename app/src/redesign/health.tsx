 ...
 *
 * Здесь нет ни одной строки о конкретном человеке — и не потому, что экран так написан,
 * а потому что база отдаёт только агрегаты. Прав читать таблицы у клиента нет ни у кого,
 * включая владельца: обещание приватности в интерфейсе не должно держаться на том, что
 * владелец не станет смотреть.
 *
